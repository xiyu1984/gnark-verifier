...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 21048378970167228211115249052197368592224371942064020137701085636921412230559;
  uint256 private constant G2_SRS_1_X_1 = 10460427342153582165090700336586305253869880391616307329783451893278663243938;
  uint256 private constant G2_SRS_1_Y_0 = 6773764790314438432725864022038051867814161897759804873240209266324051959445;
  uint256 private constant G2_SRS_1_Y_1 = 5150541997703838113915805008346157623427442003265511459767070562288804110306;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 11;
  uint256 private constant VK_DOMAIN_SIZE = 32;
  uint256 private constant VK_INV_DOMAIN_SIZE = 21204235282094297871551205565717985242031228012903033270457635305745314480129;
  uint256 private constant VK_OMEGA = 4419234939496763621076330863786513495701855246241724391626358375488475697872;
  uint256 private constant VK_QL_COM_X = 17239832545502241535867068066945550120483327016373847736682764591338357447990;
  uint256 private constant VK_QL_COM_Y = 20925709334789457081536337212655717248938460182286044111240700350079821929091;
  uint256 private constant VK_QR_COM_X = 1074526850407953916450621826499268910441480733864444237214506360672588010622;
  uint256 private constant VK_QR_COM_Y = 20458771847155090853467998388048285897325187998203415094695093407267386128904;
  uint256 private constant VK_QM_COM_X = 17028039216612487749964074119858965807134167599133480126411776334927869074946;
  uint256 private constant VK_QM_COM_Y = 4293274985798779570094768813480235672079413927650432915574593658741831909612;
  uint256 private constant VK_QO_COM_X = 2153072135571940344310996767360745372130800195772915734608686579674932104219;
  uint256 private constant VK_QO_COM_Y = 7535669883210898796157682058462572237538239623631993684673292949665629280940;
  uint256 private constant VK_QK_COM_X = 0;
  uint256 private constant VK_QK_COM_Y = 0;
  
  uint256 private constant VK_S1_COM_X = 11298454183138612849077691299200325857066347953531715992296326919381341345948;
  uint256 private constant VK_S1_COM_Y = 4196196784597383149214050755351739238149502827353365957255561069833486352783;
  
  uint256 private constant VK_S2_COM_X = 8355164397305266201380382871012845784798853066482021626050810641225282463040;
  uint256 private constant VK_S2_COM_Y = 14646742229635525383850500334333170036690860731009303575151317647836394284258;
  
  uint256 private constant VK_S3_COM_X = 18941100408355896825463369470268041100250033327497020905328189731002719682640;
  uint256 private constant VK_S3_COM_Y = 10089341063839816617135320075975808164067465506892528054467106876408940041095;
